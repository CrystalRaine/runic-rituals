...
public class RunicRitualsComponents {
    ...
    public static final DataComponentType<RuneDataComponent> ELEMENT_DATA_COMPONENT_TYPE = Registry.register(
    ...
    public static void registerComponents() {
        ...
        ItemComponentTooltipProviderRegistry.addAfter(DataComponents.DAMAGE, RunicRitualsComponents.ELEMENT_DATA_COMPONENT_TYPE);
    }
}