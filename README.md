...
|---------------------------------|------------------------------------------------------------------------------------------------------|-------------------------------------------------|-----------------------------------------------------------------------------------|
| Symbol                          | ![control logic rune](src/main/resources/assets/runic-rituals/textures/block/control_activation_rune.png) | ![shrink logic rune](src/main/resources/assets/runic-rituals/textures/block/redstone_activation_rune.png)                                                | ![shrink logic rune](src/main/resources/assets/runic-rituals/textures/block/delay_activation_rune.png)                                                                                  |
